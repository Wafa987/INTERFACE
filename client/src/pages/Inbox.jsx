...
function Inbox() {
  ...
  const getAllEmails = () => {
    ...
    const params = {
      ...
      emailReceiver: 'johnwoo@gmail.com'
    };
          ...
          {data?.map((i) => {
            return (
              <tr>
                ...
                <td colSpan={1} className="py-2 px-4 border-b border-gray-200">{i.email_sender}</td>
                ...
                <td colspan={2} className="py-2 px-4 border-b border-gray-200 text-right">
                  <p className="flex text-xs">
                    <a href="#"><FaUserTimes className="text-gray-600 mx-2"></FaUserTimes></a>
